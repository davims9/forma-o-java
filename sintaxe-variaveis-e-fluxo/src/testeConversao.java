public class testeConversao {
	public static void main(String[] args) {
		...
		float variavelFloat = 65489168.66f; // coloca o f no final para indicar que é realmente um float e não double 
		...
		System.out.println("Impressão de soma do doubre: " + somaDoubleProblema);
	}
}
